...
{form cssClass="z-form"}
    <fieldset>
		...
		<div class="z-formrow normaltext">
			{formlabel for='value' __text='Template:'}
			{formtextinput id="value" maxLength=10000 mandatory=true lines=10 rows=10 textMode='multiline' text=$data->getValue() onChange="getPreview()"}
		</div>
		<div class="z-formrow normaltext">
			{formlabel for='printTemplate' __text='Print Template:'}
			{formtextinput id="printTemplate" maxLength=10000 mandatory=true lines=10 rows=10 textMode='multiline' text=$data->getPrintTemplate()}
		</div>
		<fieldset>
